    ...
    <div className="home-container">
      ...
      <main className="hero">
        ...
        <p className="description">
          Experience the power of Gemini AI for automated, structured GitHub
          documentation. Seamlessly generate README, CONTRIBUTING, and API
          guides while maintaining complete control.
        </p>
